...
ifeq ($(CONFIG_UART_U_BOOT),y)
UART_IPL = uart_bl1
U_BOOT_UART = $(obj)/uart_bl1/$(BOARD)/skdv210-BL1-uart.bin
endif

ifeq ($(CONFIG_SD_U_BOOT),y)
SD_IPL = sd_bl1
U_BOOT_SD = $(obj)/sd_bl1/$(BOARD)/skdv210-BL1-sd.bin
endif
...
$(UART_IPL):	$(VERSION_FILE)	$(obj)include/autoconf.mk
		$(MAKE) -C $(obj)uart_bl1/$(BOARD) all

$(U_BOOT_UART):	$(UART_IPL) $(obj)u-boot.bin $(obj)include/autoconf.mk

$(SD_IPL):	$(VERSION_FILE)	$(obj)include/autoconf.mk
		$(MAKE) -C $(obj)sd_bl1/$(BOARD) all

$(U_BOOT_SD):	$(SD_IPL) $(obj)u-boot.bin $(obj)include/autoconf.mk
		rm -f bl_sekede.bin
		cat $(obj)sd_bl1/$(BOARD)/skdv210-BL1-sd0.bin.padding >bl_sekede.bin
		cat u-boot.bin >>bl_sekede.bin
		rm -f bl_sekede_sd.img
		cat $(obj)sd_bl1/$(BOARD)/skdv210-BL1-sd2.bin.padding >bl_sekede_sd.img
		cat u-boot.bin >>bl_sekede_sd.img
		cat nop.add >>bl_sekede_sd.img
...
skdv210_config :	unconfig
	@$(MKCONFIG) $(@:_config=) arm s5pc11x smdkc110 samsung s5pc110
	rm -f $(obj)board/samsung/smdkc110/config.mk
	@echo "TEXT_BASE = 0x3fe00000" > $(obj)board/samsung/smdkc110/config.mk
	@echo "CONFIG_UART_U_BOOT = y" >> $(obj)board/samsung/smdkc110/config.mk
	@echo "CONFIG_SD_U_BOOT = y" >> $(obj)board/samsung/smdkc110/config.mk
...
clean:
	@make -C $(obj)uart_bl1/smdkc110 clean
	@make -C $(obj)sd_bl1/smdkc110 clean
	...
	@rm -f $(obj)onenand_bl1/onenand-{ipl,ipl.bin,ipl-2k.bin,ipl-4k.bin,ipl.map}
...
clobber:	clean
	@find $(OBJTREE) -type f \( -name .depend \
		-o -name '*.srec' -o -name '*.bin' -o -name u-boot.img -o -name bl_sekede_sd.img \) \
		-print0 \
		| xargs -0 rm -f
	...
	@[ ! -d $(obj)uart_ipl ] || find $(obj)uart_ipl -lname "*" -print | xargs rm -f
	@[ ! -d $(obj)sd_ipl ] || find $(obj)sd_ipl -lname "*" -print | xargs rm -f
