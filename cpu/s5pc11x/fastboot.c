...
const u8 string_desc3[] = /* Test Serial ID */
{
	...
	(0x20+2), STRING_DESCRIPTOR,
	'S', 0x0, '5', 0x0, 'P', 0x0, 'V', 0x0, '2', 0x0,
	'1', 0x0, '0', 0x0, '-', 0x0, 'D', 0x0, 'e', 0x0,
	'v', 0x0, 'B', 0x0, 'o', 0x0, 'a', 0x0, 'r', 0x0,
	'd', 0x0
#elif defined(CONFIG_A8388_V1)
	(0x10+2), STRING_DESCRIPTOR,
	'A', 0x0, '8', 0x0, '3', 0x0, '8', 0x0, '8', 0x0,
	'-', 0x0, 'V', 0x0, '1', 0x0
#elif defined(CONFIG_A8388_V2)
	(0x10+2), STRING_DESCRIPTOR,
	'A', 0x0, '8', 0x0, '3', 0x0, '8', 0x0, '8', 0x0,
	'-', 0x0, 'V', 0x0, '2', 0x0
#elif defined(CONFIG_S9)
	(0x04+2), STRING_DESCRIPTOR,
	'S', 0x0, '9', 0x0
...
#else
	device_strings[DEVICE_STRING_PRODUCT_INDEX]       = "skdv210";
#endif
#else
