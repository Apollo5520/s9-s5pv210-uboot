...
//Apollo +
#define DISPLAY_CONTROL_OFFSET		0x7008
#define BLK_PWR_STAT      (ELFIN_CLOCK_POWER_BASE + BLK_PWR_STAT_OFFSET)
#define NORMAL_CFG        (ELFIN_CLOCK_POWER_BASE + NORMAL_CFG_OFFSET)
#define DISPLAY_CONTROL   (ELFIN_CLOCK_POWER_BASE + DISPLAY_CONTROL_OFFSET)
#define CLK_SRC_MASK0     (ELFIN_CLOCK_POWER_BASE + CLK_SRC_MASK0_OFFSET)
#define CLK_SRC1          (ELFIN_CLOCK_POWER_BASE + CLK_SRC1_OFFSET)
#define CLK_DIV_STAT0     (ELFIN_CLOCK_POWER_BASE + CLK_DIV_STAT0_OFFSET)

#define CLK_GATE_IP0	    (ELFIN_CLOCK_POWER_BASE + CLK_GATE_IP0_OFFSET)
#define CLK_GATE_IP1	    (ELFIN_CLOCK_POWER_BASE + CLK_GATE_IP1_OFFSET)
#define CLK_GATE_IP2	    (ELFIN_CLOCK_POWER_BASE + CLK_GATE_IP2_OFFSET)
#define CLK_GATE_IP3	    (ELFIN_CLOCK_POWER_BASE + CLK_GATE_IP3_OFFSET)
#define CLK_GATE_IP4	    (ELFIN_CLOCK_POWER_BASE + CLK_GATE_IP4_OFFSET)
#define CLK_GATE_BLOCK    (ELFIN_CLOCK_POWER_BASE + CLK_GATE_BLOCK_OFFSET)

#define CLK_SRC_MASK1     (ELFIN_CLOCK_POWER_BASE + CLK_SRC_MASK1_OFFSET)
#define CLK_SRC3          (ELFIN_CLOCK_POWER_BASE + CLK_SRC3_OFFSET)
