...
.include "../../include/s5pc110_reg.inc"
...
.endif
	...
	ldr	r1, =0x00100552				@DirectCmd	chip1 MRS (MEM DLL reset) CL=3, BL=4
	str	r1, [r0, #DMC_DIRECTCMD]
...
.endif
	...
	ldr	r1, =0x00000552				@DirectCmd	chip0 MRS (MEM DLL reset) CL=4, BL=4
	str	r1, [r0, #DMC_DIRECTCMD]
	...
	ldr	r1, =0x00100552				@DirectCmd	chip1 MRS (MEM DLL reset) CL=4, BL=4
	str	r1, [r0, #DMC_DIRECTCMD]
...
mem_ctrl_asm_init:
	...
	ldr	r1, =DMC0_PHYCONTROL1				@PhyControl1 DLL parameter setting, LPDDR Case
	str	r1, [r0, #DMC_PHYCONTROL1]
...
.endif
	...
	ldr	r1, =0x00000032				@DirectCmd	chip0 MRS (MEM DLL unreset)
	str	r1, [r0, #DMC_DIRECTCMD]
	...
	ldr	r1, =0x00100032				@DirectCmd	chip1 MRS (MEM DLL unreset)
	str	r1, [r0, #DMC_DIRECTCMD]
	...
	ldr	r1, =DMC0_MEMCONTROL				@MemControl	BL=4, 2 chip, LPDDR type, dynamic self refresh, force precharge, dynamic power down off
	str	r1, [r0, #DMC_MEMCONTROL]

	mov	pc, lr
.endif /* CONFIG_HYNIX_MCP */
/*///////////////////////////////////////////////////////////////////////////////////////////////////////////*/
