...
.endif
	...
	ldr	r1, =0x00000532				@DirectCmd	chip0 MRS (MEM DLL reset) CL=3, BL=4
	str	r1, [r0, #DMC_DIRECTCMD]
	...
	ldr	r1, =0x00100532				@DirectCmd	chip1 MRS (MEM DLL reset) CL=3, BL=4
	str	r1, [r0, #DMC_DIRECTCMD]
	...
	ldr	r1, =0x00100432				@DirectCmd	chip1 MRS (MEM DLL unreset)
	str	r1, [r0, #DMC_DIRECTCMD]
